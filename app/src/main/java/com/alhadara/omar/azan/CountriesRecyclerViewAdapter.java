...
public class CountriesRecyclerViewAdapter extends RecyclerView.Adapter<CountriesRecyclerViewAdapter.CountriesRecyclerViewHolder>{
    ...
    @NonNull
    @Override
    public CountriesRecyclerViewAdapter.CountriesRecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CountriesRecyclerViewAdapter.CountriesRecyclerViewHolder holder, int position) {
